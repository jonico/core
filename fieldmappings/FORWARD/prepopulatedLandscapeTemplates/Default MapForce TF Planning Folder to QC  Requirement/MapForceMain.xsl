	...
	<xsl:template match="/">
		<artifact>
			<xsl:attribute name="xsi:noNamespaceSchemaLocation">
				<xsl:value-of select="'C:/DOCUME~1/XPMUser/MYDOCU~1/CCFLIV~1/CCFLIV~1/samples/QCTFNG/TF2QC/xslt/QUALIT~3.XSD'"/>
			</xsl:attribute>
			...
			<xsl:for-each select="$var1_instance/artifact">
				...
				<topLevelAttributes>
					...
					<xsl:attribute name="artifactAction">
						<xsl:choose>
							<xsl:when test="string(((string(topLevelAttributes/@artifactAction) = 'update') or (string(topLevelAttributes/@artifactAction) = 'resync'))) != 'false'">
