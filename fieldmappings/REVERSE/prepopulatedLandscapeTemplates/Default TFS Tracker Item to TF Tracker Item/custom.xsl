...
<xsl:stylesheet version="2.0"
	...
	<xsl:template match='ccf:field[@fieldName="System.Title"]' mode="nonSpecificFields">
		<field>
			<xsl:copy-of select="@*" />
	...
	<xsl:template match='ccf:field[@fieldName="Microsoft.VSTS.TCM.ReproSteps"]' mode="bugSpecificFields">
