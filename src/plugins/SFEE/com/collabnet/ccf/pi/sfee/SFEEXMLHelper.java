...
public class SFEEXMLHelper {
	...
	public static void addField(Element root,
		...
		addField(root, fieldName, fieldValue, fieldType, isFlexField, fieldName, fieldValue==null,"0","unbounded");
	}
	
	public static void addMetaField(Element root,
			String fieldName, String fieldType, boolean isFlexField, String newFieldName, boolean emptyValueMeansNullValue, String minOccurs, String maxOccurs) {
		...
		child.addAttribute("newName", newFieldName);
		child.addAttribute("emptyValueMeansNullValue", emptyValueMeansNullValue?"true":"false");
		child.addAttribute("minOccurs", minOccurs);
		child.addAttribute("maxOccurs", maxOccurs);
	}
	
	public static void addField(Element root,
			String fieldName, Object fieldValue, String fieldType, boolean isFlexField, String newFieldName, boolean emptyValueMeansNullValue, String minOccurs, String maxOccurs) {
		// TODO Let user specify value of item
		// it is no problem if elements with the same attribute values are inserted more than once
		//Element child=root.addElement(generateElementName("field"),"http://sfee-conigma.open.collab.net");
		Element child=root.addElement(generateElementName("field"));
		...
		// To code the field type information here is redundant, but perhaps we later want to skip the value and type subelement in the case of schema-generation
		child.addAttribute("fieldType", fieldType);
	...
	public static List<NamesTypesAndValues> getAllFlexFields(Document data) {
