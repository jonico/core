...
//		if(dataType.equals("DATE") && (editStyle!=null && editStyle.equals("DateCombo")) ) 
	...
	//This method handles only String data type as of now.
	// TODO Change this to handle other types too.
	public FieldValueTypeValue convertSFDataTypeToGADatatype(String fieldType) {
