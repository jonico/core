...
/**
 * This class represents the required objects needed for a SOAP API connection.
 * This is just a holder class for the SOAP API connection objects. The objects
 * that are held by this class are 1) The ISourceForgeSoap SOAP app object 2)
 * The session id created after login method is called with the appropriate
 * username and password 3) The username used to login into SOAP server - This
 * is the Connector user's username
 * 
...
public class Connection {
    ...
    /**
     * Constructs a holder object for the 1) ISourceForgeSoap object 2) The
     * session id and 3) the username
     * 
     * @param username
     *            - the connector username
     * @param password
     *            - the connector password
     * @param sfSoap
     *            - The ISourceForgeSoap object that is connected to the SOAP
     *            server
     * @param sessionId
     *            - The login session id
     */
    public Connection(String username, String password,
            ISourceForgeSoap sfSoap, String sessionId) {
