...
public class TFArtifactMetaData {
	...
	public enum TFFields {
		...
		startDate("startDate", "Start date", FIELD_TYPE.SYSTEM_DEFINED, GenericArtifactField.FieldValueTypeValue.DATE, false,""),
		endDate("endDate", "End date", FIELD_TYPE.SYSTEM_DEFINED, GenericArtifactField.FieldValueTypeValue.DATE, false,""),
		...
		planningFolderHumanReadableName("planningFolderHumanReadableName", "Planning Folder Human Readable Name", FIELD_TYPE.CONFIGURABLE, GenericArtifactField.FieldValueTypeValue.STRING, false,""),
