...
public enum ISTMandatoryFieldType {
    ...
    OpenerName(true, ISTCustomFieldType.List, false, FieldValueTypeValue.STRING, true),
    OwnerId(true, ISTCustomFieldType.Integer, false, FieldValueTypeValue.STRING, true),
    OwnerName(true, ISTCustomFieldType.List, false, FieldValueTypeValue.STRING, true),
    ...
    ProjectId(true, ISTCustomFieldType.Integer, false, FieldValueTypeValue.STRING, true),
    ProjectName(true, ISTCustomFieldType.Text, false, FieldValueTypeValue.STRING, true),
