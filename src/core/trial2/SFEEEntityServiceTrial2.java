...
public class SFEEEntityServiceTrial2 extends QCConnectHelper implements
	...
	private static final Log log = LogFactory.getLog(SFEEEntityServiceTrial2.class);
    ...
    public SFEEEntityServiceTrial2(String id) {
	    super(id);
	}
	...
	public Object[] process(Object data) {
		...
		log.error("=================================");
		log.error("Entering SFEEEntityServiceTrial2");
		...
		targetArtifactId += ga.getArtifactValue();
	...
	public SFEEEntityServiceTrial2() {
		super();
	}
}
