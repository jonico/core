...
public class Obfuscator {
	...
	public static String deObfuscatePassword(String password) {
		...
		return deObfuscateString(password.substring(OBFUSCATED_PASSWORD_PREFIX.length()));
	}
	...
	private static void usage() {
		System.err.println("usage: java " + Obfuscator.class.getName() + " <passwordToObfuscate>");
	}
