...
public final class CCFUtils {
    ...
    public static String getTempFileName(Document document)
        ...
        String repositoryKey = sourceSystemId + delimiter + sourceRepositoryId
                + delimiter + targetSystemId + delimiter + targetRepositoryId;
        for (String replaceCharacter : replaceCharacters) {
            repositoryKey = repositoryKey.replaceAll(replaceCharacter,
                    delimiter);
        }
