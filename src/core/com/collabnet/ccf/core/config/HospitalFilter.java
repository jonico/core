 ...
 * a CCFRuntimeException with the message configured in the property "exceptionMessage",
 * causing the artifact to be hospitalized. 
 * 
 * @author jnicolai, ctaylor
 * 
 */
public class HospitalFilter extends ScriptProcessor implements
		IDataProcessor {
	...
	public void validate(List exceptions) {
		...
		if (StringUtils.isEmpty(getExceptionMessage())) {
			exceptions.add(new ValidationException("exceptionMessage is null or empty.", this));
		}
	}

	/**
	 * define the exception message to be thrown if the script doesn't return successfully.
	 * 
	 * @param exceptionMessage the message of the CCFException 
	 */
