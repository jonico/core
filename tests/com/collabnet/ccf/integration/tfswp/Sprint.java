...
public enum Sprint {
     ...
     */
    SPRINT_1_AUTOMATED_TEAM("Initial test sprint for AutomatedTestTeam",
            "4/15/2010", "5/12/2010", "AutomatedTestTeam"),

    /**
     * Second sprint for the automated test team.
     */
    SPRINT_2_AUTOMATED_TEAM("Second test sprint", "4/15/2010", "6/18/2010",
            "AutomatedTestTeam"),

    /**
     * First sprint for the one team.
     */
    SPRINT_1_ONE_TEAM("Initial sprint for OneTeam", "4/15/2010", "6/11/2010",
            "OneTeam");

    /** Date format of M/D/YYYY. */
    private final SimpleDateFormat dateFormatMonthDayYear  = new SimpleDateFormat(
                                                                   "M/d/yyyy");

    /** Date format of YYYY-MM-DD. */
    private final SimpleDateFormat dateFormatYearMonthYear = new SimpleDateFormat(
                                                                   "yyyy-MM-dd");
     ...
     * @param team
     *            the name of the team associated to this sprint
     */
    private Sprint(final String name, final String start, final String end,
            final String team) {
    ...
    /**
     * @return the end date in YYYY-MM-DD format without leading 0 for single
     *         digit month or day
     */
    ...
    /**
     * @return the end date in YYYY-MM-DD format with two digits for month and
     *         day
     */
    ...
    /**
     * @return the start date in M/D/YYYY format without leading 0 for single
     *         digit month or day
     */
    ...
    /**
     * @return the start date in M/D/YYYY format with two digits for month and
     *         day
     */
