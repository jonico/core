...
<xsl:stylesheet version="2.0"
	...
	<!-- <xsl:template
		match='ccf:field[@fieldName="{urn:ws.tracker.collabnet.com}Created On:"]'>
		<field>
		    <xsl:attribute name="fieldName">Created On field Name in QC</xsl:attribute>
		    <xsl:attribute name="fieldDisplayName">Description</xsl:attribute>
		    <xsl:attribute name="fieldAction"><xsl:value-of select="@fieldAction" /></xsl:attribute>
		    <xsl:attribute name="fieldType"><xsl:value-of select="@fieldType" /></xsl:attribute>
		  	<xsl:attribute name="fieldValueHasChanged"><xsl:value-of select="@fieldValueHasChanged" /></xsl:attribute>
	...
	<xsl:template
		...
		<field>
		    <xsl:attribute name="fieldName">Reason field Name in QC</xsl:attribute>
		    <xsl:attribute name="fieldDisplayName">Description</xsl:attribute>
		    <xsl:attribute name="fieldAction"><xsl:value-of select="@fieldAction" /></xsl:attribute>
		    <xsl:attribute name="fieldType"><xsl:value-of select="@fieldType" /></xsl:attribute>
		  	<xsl:attribute name="fieldValueHasChanged"><xsl:value-of select="@fieldValueHasChanged" /></xsl:attribute>
	...
	<xsl:template
		match='ccf:field[@fieldName="{urn:ws.tracker.collabnet.com}Modified By:"]'>
		<field>
		    <xsl:attribute name="fieldName">Reason field Name in QC</xsl:attribute>
		    <xsl:attribute name="fieldDisplayName">Reason field display Name in QC</xsl:attribute>
		    <xsl:attribute name="fieldAction"><xsl:value-of select="@fieldAction" /></xsl:attribute>
		    <xsl:attribute name="fieldType"><xsl:value-of select="@fieldType" /></xsl:attribute>
		  	<xsl:attribute name="fieldValueHasChanged"><xsl:value-of select="@fieldValueHasChanged" /></xsl:attribute>
		  	<xsl:attribute name="fieldValueType"><xsl:value-of select="@fieldValueType" /></xsl:attribute>
	...
	<xsl:template
		...
		<field>
		    <xsl:attribute name="fieldName">Created by field Name in QC</xsl:attribute>
	...
	<xsl:template
		match='ccf:field[@fieldName="{urn:ws.tracker.collabnet.com}Modified On:"]'>
		<field>
		    <xsl:attribute name="fieldName">Modified on field Name in QC</xsl:attribute>
