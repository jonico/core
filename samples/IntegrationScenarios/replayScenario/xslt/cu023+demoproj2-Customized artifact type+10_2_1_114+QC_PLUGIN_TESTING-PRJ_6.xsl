...
<xsl:stylesheet version="2.0"
	...
	<xsl:template
        ...
        <field>
            ...
            <xsl:attribute name="fieldDisplayName">PT ID</xsl:attribute>
            <xsl:attribute name="fieldAction"><xsl:value-of select="@fieldAction" /></xsl:attribute>
            <xsl:attribute name="fieldType">mandatoryField</xsl:attribute>
            <xsl:attribute name="fieldValueHasChanged"><xsl:value-of select="@fieldValueHasChanged" /></xsl:attribute>
            <xsl:attribute name="fieldValueType"><xsl:value-of select="@fieldValueType" /></xsl:attribute>
	...
	<xsl:template
		match='ccf:field[@fieldName=concat($artifactTypeNameSpace,"Short description")]'>
		<field>
	...
	<xsl:template
		match='ccf:field[@fieldName=concat($artifactTypeNameSpace,"Test Date")]'>
		<field>
	...
	<xsl:template
		match='ccf:field[@fieldName=concat($artifactTypeNameSpace,"QA Contact Email")]'>
		<field>
	...
	<xsl:template
		match='ccf:field[@fieldName=concat($artifactTypeNameSpace,"Testing hours")]'>
		<field>
	...
	<xsl:template
		match='ccf:field[@fieldName=concat($artifactTypeNameSpace,"Component affected")]'>
		<field>
	...
	<xsl:template
		match='ccf:field[@fieldName=concat($artifactTypeNameSpace,"Found in version")]'>
		<field>
	...
	<xsl:template
		match='ccf:field[@fieldName=concat($artifactTypeNameSpace,"Reproduction steps")]'>
		<field>
	...
	<xsl:template
		match='ccf:field[@fieldName=concat($artifactTypeNameSpace,"DOB")]'>
		<field>
		    <xsl:attribute name="fieldName">BG_USER_08</xsl:attribute>
		    <xsl:attribute name="fieldDisplayName">DOB</xsl:attribute>
		    <xsl:attribute name="fieldAction"><xsl:value-of select="@fieldAction" /></xsl:attribute>
		    <xsl:attribute name="fieldType">mandatoryField</xsl:attribute>
		  	<xsl:attribute name="fieldValueHasChanged"><xsl:value-of select="@fieldValueHasChanged" /></xsl:attribute>
		  	<xsl:attribute name="fieldValueType"><xsl:value-of select="@fieldValueType" /></xsl:attribute>
