...
1. Created on time
    ...
    with the name "{urn:ws.tracker.collabnet.com}Created On:"
...
3. Modified by field
    This field's value is encoded in a GenericArtifact field
    with the name "{urn:ws.tracker.collabnet.com}Modified By:"
...
4. Created by field
    This field's value is encoded in a GenericArtifact field
    with the name "{urn:ws.tracker.collabnet.com}Created By:"
...
5. Modified on field
    This field's value is encoded in a GenericArtifact field
    with the name "{urn:ws.tracker.collabnet.com}Modified On:"
